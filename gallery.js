...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ৬. ফায়ারবেস থেকে গ্যালারি ডেটা লোড
  if (galleryContainer) {
    database.ref('gallery').once('value').then((snapshot) => {
      if (snapshot.exists()) {
        galleryContainer.innerHTML = '<h3>গ্যালারি</h3>';
...
document.querySelectorAll('img').forEach(img => {
  ...
  const silverCategories = [
    { name: "ব্রেসলেট", img: "https://bajus-live.github.io/storage/gallery/silver/breslate/cover/breslate.png" },
    { name: "নুপুর", img: "https://bajus-live.github.io/storage/gallery/silver/nupur/cover/nupur.png" },
    { name: "আংটি", img: "https://bajus-live.github.io/storage/gallery/silver/ring/cover/ring.jpg" },
    { name: "হার", img: "https://bajus-live.github.io/storage/gallery/silver/chain/cover/chain.png" },
    { name: "টো রিং", img: "https://bajus-live.github.io/storage/gallery/silver/toe_ring/cover/toe_ring.png" },
